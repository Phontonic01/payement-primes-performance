...
const historiques = [
  { id: 1, date: '2025-12-10', agent: 'Jean MOUSSAVOU', type: 'Checklist Terrain', resultat: '5.0 / 5', impact: 'Aucun' },
  { id: 2, date: '2025-12-10', agent: 'Jean MOUSSAVOU', type: 'Alcootest', resultat: 'Négatif', impact: 'Aucun' },
  { id: 3, date: '2025-12-09', agent: 'Paul ONDO', type: 'Alcootest', resultat: 'Positif (0.5g/l)', impact: '-5 pts (Pénalité globale)' },
  { id: 4, date: '2025-12-08', agent: 'Kevin MVOUMA', type: 'Checklist Terrain', resultat: '3.5 / 5', impact: 'EPI manquant' },
]
</script>
  ...
  <div class="space-y-6">
      ...
      <div class="flex items-center justify-between">
        <div class="flex items-center gap-3">
          ...
          <p class="text-sm font-semibold text-red-700">
            1 pénalité majeure (Alcootest) détectée ce mois-ci.
          </p>
        </div>
    ...
    <BaseCard>
      ...
      <div class="flex flex-col md:flex-row gap-4 mb-6">
        <input
          type="month"
          class="block text-sm bg-gray-50 border border-gray-200 rounded-xl px-3 py-2.5 text-gray-900 focus:border-emerald-500 focus:ring-1 focus:ring-emerald-500 transition-colors"
        />
      ...
      <BaseTable :columns="columns" :rows="historiques">
        <template #cell-resultat="{ value }">
          <span class="font-medium" :class="value.includes('Positif') ? 'text-red-600 font-bold' : 'text-gray-900'">
            {{ value }}
          </span>
        </template>

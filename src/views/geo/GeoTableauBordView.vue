...
import { MapPin, AlertTriangle, CheckCircle, XCircle, Eye, Truck, Wrench, ShieldCheck, TrendingUp } from 'lucide-vue-next'
  ...
  <div class="space-y-6">
    ...
    <template v-else>
      ...
      <div class="space-y-4">
        ...
        <div v-for="item in synthese" :key="item.id" class="bg-white rounded-xl border overflow-hidden"
